...
🔗 Referência: [Strategy - Refactoring Guru](https://refactoring.guru/pt-br/design-patterns/strategy)

### Pattern
- **Diagrama UML**
  *(Espaço para imagem UML do Strategy Pattern)*  
- **Código**
  *(Espaço para código Strategy Pattern)*  

### Anti-Pattern
- **Diagrama UML**
  *(Espaço para imagem UML do Strategy Anti-Pattern)*  
- **Código**
  *(Espaço para código Strategy Anti-Pattern)*  
