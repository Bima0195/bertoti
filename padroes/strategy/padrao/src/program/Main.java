...
public class Main {
	...
	public static void main(String[] args) {
		...
		list.add(new ClienteComum("Ana"));
		list.add(new Empresa("Fatec"));
		list.add(new Aposentado("Pedro"));
		list.add(new Estudante("Aluno"));
		...
		for (Cliente cli : list) {
		    ...
		    if (cli instanceof Emprestimo) {
		        Emprestimo e = (Emprestimo) cli;
		        System.out.println(e.emprestar());
		    } else {
		        System.out.println("Não pode realizar emprestimo");
		    }
		}
